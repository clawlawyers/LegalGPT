          ...
          <div className="mt-12 h-full md:h-72 w-full grid md:grid-cols-2 items-center justify-center gap-5">
              ...
              <div className="w-full h-full flex flex-col gap-2 py-2">
                ...
                <div className="h-full flex-1 flex flex-col gap-2 justify-between">
                  <p className="text-center md:text-start">
                    ...
                    and get accurate results for court prep or research, making
                    your legal journey faster and easier.
                  </p>
            ...
            <div className="grid md:grid-cols-[30%_70%] w-full h-full justify-center items-center border-2 rounded-lg p-3">
              ...
              <div className="w-full h-full flex flex-col gap-2 py-2">
                ...
                <div className="h-full flex-1 flex flex-col gap-2 justify-between">
                  <p className="text-center md:text-start">
                    Revolutionize legal research with LegalGPT. Instantly access
                    case summaries, references, insights, and tailored
                    precedents. Get accurate info in minutes, skipping endless
                    document searches, and unlock AI-driven legal intelligence.
                  </p>
